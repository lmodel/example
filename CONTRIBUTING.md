...
The following is a set of guidelines for contributing to sample. 
...
The sample team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/sample/issues/) for reporting problems with the ontology. 
